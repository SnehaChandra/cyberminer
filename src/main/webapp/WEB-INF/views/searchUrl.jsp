...
<div class="navbar navbar-inverse navbar-fixed-top hea">Your search returned the following links!</div>

<div align="center" style="padding-top: 70px;">
    <a href="hello" class="btn btn-primary" role="button" >Go back to Search</a>
</div>
